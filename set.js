...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~OuBEDcfCUCOnwpx2cyzD", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "260774029289", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "JUSINES", // Input Yours custom...(Maintain font for Flow)
